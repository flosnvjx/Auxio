                    ...
                    object : MediaCodecAdapter.Factory {
                        ...
                        override fun createAdapter(
                            ...
                            if (configuration.format.sampleMimeType == MimeTypes.AUDIO_AAC) {
                                // Disable DRC (0) when ReplayGain is off, set to -18 LUFS when
                                // ReplayGain is active
                                val drcLevel =
                                ...
                                // Enable album mode DRC only when using Album ReplayGain
                                val albumMode =
                                    if (playbackSettings.replayGainMode == ReplayGainMode.ALBUM) 1
                                    else 0
                                configuration.mediaFormat.setInteger(
